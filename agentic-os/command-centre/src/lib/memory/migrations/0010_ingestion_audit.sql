-- ============================================================================
-- Team OS Phase 3 — ingestion audit events
--
-- Shared content imports and retries are sensitive admin actions. Extend the
-- audit vocabulary so those actions are queryable by team and by source/import.
-- ============================================================================
